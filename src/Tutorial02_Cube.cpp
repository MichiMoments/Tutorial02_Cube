...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[12] =
        {
            
            {float3{0, -0.5, +0.5}, float4{1, 0, 0, 1}}, 
            {float3{-2, 1, +0.5}, float4{1, 0.2, 0.2, 1}},
            {float3{-1, 2, +0.5}, float4{1, 0.4, 0.4, 1}}, 
            {float3{0, 1, +0.5}, float4{1, 0.6, 0.6, 1}},  
            {float3{1, 2, +0.5}, float4{1, 0.4, 0.4, 1}},  
            {float3{2, 1, +0.5}, float4{1, 0.2, 0.2, 1}},  
...
void Tutorial02_Cube::Update(double CurrTime, double ElapsedTime)
{
    ...
    float4x4 View = float4x4::Translation(0.f, -0.8f, 7.0f);
